/* 
 *  sample6.c : A C program example for practising static code analysis
 *  This program includes SPLINT errors that can be easily fixed by the
 *  user.
 *
 *  Directions:
 *    1.  Run splint on this program      (splint sample2.c)
 *    2.  Edit this file to fix the errors.   
 *    3.  Re-run splint on the updated program.
 *  
