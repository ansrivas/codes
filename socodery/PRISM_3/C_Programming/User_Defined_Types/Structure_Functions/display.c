...
*  FILE NAME    : display.c
*
*  DESCRIPTION  : Function Definitions definitions for displaying a
*		  structure using different methods.Also demonstrates
*		  their differences.
*
			  ...
			  )
{
 ...
 printf("Structure Argument (Pass Whole Structure)\n");
 printf("******************\n");
                              ...
                              )
{
 ...
 printf("Pointer to Structure Argument(Pass Pointer to Structure)\n");
 printf("*****************************\n");
 printf("Size of the argument is %d\n", sizeof(arg_ptr));
                               ...
                               )
{
 ...
 printf("Structure Element Argument (Individual elements)\n");
 printf("**************************\n");
