/*************************************************************************
*
*  FILE NAME    : file_line.c
*
*  DESCRIPTION  : Demonstrates line reading and writing with a file. 
*		  The issues with fgets and feof are also demonstrated.
*
