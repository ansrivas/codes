/*******************************************************************************
*
*     FILENAME       :    other_functions.c
*
*     DESCRIPTION    :    This file defines the functions to perform operations *		like displaying the list, freeing the list and checking the     *		emptiness of the list.
*
*     Revision History    :
