/* bugs
1) Allocate size > 64. It crashes
2) Free an invalid pointer. It crashes
3) Allocate 10 bytes. Free the pointer. Allocate 10 bytes again. Now, busy list is erroneous
*/
