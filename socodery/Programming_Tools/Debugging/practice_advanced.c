/*************************************************************************
*
*  FILE NAME    : advanced_practice.c
*
*  DESCRIPTION  : Printing the names from a structure of names. 
*
*  DATE    NAME    REFERENCE          REASON
*
*  8-MAR-08  Sibu    PT FG 1.0           Initial creation
*
...
*
* DESCRIPTION: Search for a string using binary search
*
